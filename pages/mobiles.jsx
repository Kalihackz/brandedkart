...
export default function mobiles( { data, addToCart, removeFromCart } ) {
	...
	return (
		<div>
			<Head>
				<title>Branded Kart | Mobiles</title>
				<meta charSet="UTF-8" />
				<meta name="description" content="Welcome to Mobiles Section." />
...
export async function getServerSideProps() {
    ...
    const res = await fetch(`${process.env.SERVER_URI}/api/items/mobile`)
